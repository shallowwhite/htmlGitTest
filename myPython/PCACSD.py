...
class ChipShopDetector:
    ...
    def search_chip_shop(self, location):
        ...
        for place in data.get('results', []):
            if place.get('user_ratings_total', 0) >= 250 and place.get('rating', 0) >= 4.2: #set  parameters of min user ratings total and minimum stars
                result = {
                    'name': place['name'],
...
if __name__ == "__main__":
    ...
    current_location = "53.64586363040967, -3.0099745138322564"  # Enter you coords
